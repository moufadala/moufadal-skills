...
category: baoyu-infographic
title: Baoyu Infographic
description: Design educational or explanatory infographics using Baoyu-style layout and visual systems, including 21 layouts and 21 styles. Use when the user asks for structured visual summaries, information graphics, comparison posters, or Chinese/English infographic prompts.
version: 1.56.1
author: 宝玉 (JimLiu)
license: MIT
