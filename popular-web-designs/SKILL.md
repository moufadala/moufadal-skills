...
category: popular-web-designs
title: Popular Web Designs
description: "54 real design systems (Stripe, Linear, Vercel) as HTML/CSS. Use whenever the user asks about popular web designs, related setup, troubleshooting, automation, workflows, reports, or artifacts, even if they do not explicitly name this skill."
version: 1.0.0
