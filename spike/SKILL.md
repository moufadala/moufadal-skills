...
## Reusable evaluation references

- `references/graphify-evaluation-pattern.md` — pattern for spiking codebase-context/navigation tools like Graphify before adding them to the Hermes/Claude/Codex stack: non-destructive `uvx` run, code-only mirrors, workflow query hit-rate, false-negative checks, and threshold-based adoption.
