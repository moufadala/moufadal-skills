...
# Windows consoles default to cp1252 and crash when the report prints non-ASCII
# glyphs (→, …). Force UTF-8 so /watch works cross-platform. Guarded for streams
# that predate reconfigure() (Python < 3.7) or aren't real text streams.
