...
category: excalidraw
title: Excalidraw
description: Create hand-drawn Excalidraw JSON diagrams for architecture, flows, sequence diagrams, systems, and explanations. Use when the user wants an editable sketch-style diagram rather than polished SVG/HTML visuals.
version: 1.0.0
author: Hermes Agent
license: MIT
dependencies: []
