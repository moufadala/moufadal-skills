...
category: design-md
title: Design Md
description: "Author/validate/export Google's DESIGN.md token spec files. Use whenever the user asks about design md, related setup, troubleshooting, automation, workflows, reports, or artifacts, even if they do not explicitly name this skill."
version: 1.0.0
author: Hermes Agent
license: MIT
